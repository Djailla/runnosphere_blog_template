						...
						<div class="page_cont">
							<?php
								...
								for($i=0; $i<sizeof($users); $i++){
									...
									if($disp != "1"){
										$list .= "<p>- <a href='#member-".$u->ID."'>".$u->display_name."</a></p>";
										...
										// unset($social);
										// $social = get_user_meta($u->ID, "skype_address", true);
										// if(!empty($social)){
										// 	$nb++;
										// 	$html .= "<a target='_blank' href='".$social."' title='Skype' class='skype_social'></a>";
										// }
										...
										unset($social);
										$social = get_user_meta($u->ID, "gprun_address", true);
										if(!empty($social)){
											$nb++;
											$html .= "<a target='_blank' href='".$social."' title='GoodPeopleRun' class='gprun_social'></a>";
										}
								...
								print("<div class='author_list'>".$list."</div>");
								print($html);
						?>       
						</div>
					</div>
