					...
					<div class="post" id="post-<?php the_ID();?>">
						...
						<div class="post_sub_infos">
							...
							<div class="post_share">
								...
								<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4e1d84a413b3664e"></script>
								<!-- AddThis Button END -->
						...
						<div class="post_author" style="display:block;">
							Post&eacute; par <a href="<?php the_author_meta('user_url'); ?>" target="_blank"><?php the_author(); echo "</a>"; echo get_avatar( get_the_author_id(), $size = '36' ); ?>
						</div>
