...
class runnosphere_PASTA extends WP_Widget {
    ...
    function widget($args, $instance) {		
		...
		if(''.$title == ''){
			...
			//Facebook
			$html_title .= '<a href="'.$link.'" class="facebook_widget_link" title="Facebook"><img class="facebook_widget_logo" alt="" src="'.get_bloginfo('stylesheet_directory').'/images/widgets/facebook_logo.jpg" /></a>';
