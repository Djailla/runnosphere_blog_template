...
<label for="author"><small>Nom <?php if ($req) echo "(required)"; ?></small></label>
</p>

<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
<label for="email"><small>Adresse e-mail (ne sera pas publié) <?php if ($req) echo "(required)"; ?></small></label>
</p>
